...
#define COMMUNICATION_PORT "10001"             // the port on ZedBoard for communicating with XDAQ
	...
	while(1)
	{
		...
		if (receiveAndAcknowledge(communicationSocket, messageSender, communicationBuffer) >= 0){
			...
			if (communicationBuffer.substr(0,5) == "START")
			{
				...
				std::string command = "cd /home/daq/DRS4DAQ/WaveDumpDT5742/; ./src/wavedumpDAQ /home/daq/DRS4DAQ/WaveDumpDT5742/Setup/WaveDumpConfig.txt " + fileName + " &";
